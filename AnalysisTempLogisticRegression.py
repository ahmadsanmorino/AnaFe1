# Analysis for Logistic Regression Classification
...
# LR Classification report (Accuracy, Precision, Sensitivity, f1-score) 
...
def plot_roc_curve(fpr, tpr):
    ...
    plt.title('LR Receiver Operating Characteristic Curve')
    plt.legend()
    plt.show()
